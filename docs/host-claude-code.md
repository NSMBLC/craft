...
`/craft-approve package`, `/craft-reject package`, `/craft-reopen problem|review`, `/craft-untaint`, or the same with
...
`craft approve|reject|close|reopen|untaint`, `CRAFT_ALLOW_NON_TTY`, and any
