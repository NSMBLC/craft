---
name: craft-approve
description: Researcher decision: approve the one-page problem statement (`/craft-approve problem`) or a proposed package addition (`/craft-approve package`).
---

Usage: `/craft-approve problem [--inv <id>] [--note "..."]` or `/craft-approve package [--lock <file>]`
